...
controls = (function() {
  ...
  controls.prototype.init = function(kaleid) {
    ...
    $(document).bind('keypress', __bind(this.pause, this));
  }
  ...
  controls.prototype.toggleMirrors = function(e) {
    ...
    if (!this.oscope.view.reflect) {
      ...
      // this.oscope.view.canvas.style.display = 'block';
      // this.oscope.view.mirrors.style.display = 'none';
      // this.oscope.view.mctx.clearRect(0, 0, this.oscope.width, this.oscope.height);
    } else {
      // this.oscope.view.mirrors.style.display = 'block';
      // this.oscope.view.canvas.style.display = 'none';
